...
import com.gmail.fitostpm.staffs.listeners.IteractListeners;
...
public class MainClass extends JavaPlugin
{
	...
	public static HashMap<Projectile,ItemStaff> _LaunchedMissiles = new HashMap<Projectile,ItemStaff>();	
	
	//Map of players that casting a charge and an instance of class that responsible for the process
	public static HashMap<Player, ItemStaff> _CastingPlayers = new HashMap<Player, ItemStaff>();
	...
	{				
		...
		getServer().getPluginManager().registerEvents(new IteractListeners(), this);
	...
	public void Repair(Player player, ItemStack item)
	{
		...
		if(ItemStaff.isStaff(player.getInventory().getItemInMainHand()))
		{
